...
Use `AI-Speed-All-Chapters-DeltaMod-v1.1.0.zip` in `deltamod/`. It is a real
standalone speed mod and can be enabled beside the separate telemetry v9.0.2
mod. DeltaMod works on protected copies of the chapter data, so the Steam
